...
<body>
                           ...
                           <div class="menu-main d-flex align-items-center justify-content-end">
                               <!-- Main-menu -->
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            <li><a href="memberhome.php">Back</a></li>
    ...
    <main>
        ...
        <div class="contact-form-main mb-100">
            ...
            $result11 = mysqli_query($con,"select * from schedule") or die(mysqli_error($con)); 
            ...
            ?>
              ...
              <tr>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td><?php echo $result22['schid']; ?> </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['tm']; ?>  </td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['dat']; ?></td>
