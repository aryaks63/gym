...
<head>
    ...
    <title> Health & Fitness | Schedule </title>
...
<body>
        ...
        ?>
         ...
         if(isset($_POST['add'])){
			...
			$result =  mysqli_query($con, "select * from schedule where  tm='$a' and dat='$b' and mid='$c'") or die(mysqli_error($con));
        ...
        if($kk==0)   
		{			
        mysqli_query($con, "insert into schedule(tm,dat,mid) values ('$a','$b','$c')");
		           echo "<script>alert('Schedule added')</script>"; } 
		else
		 {echo "<script>alert('Schedule already exists')</script>";}		 
	 }  ?>
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-7 col-lg-7">
                        <div class="form-wrapper">
                            ...
                            <!--End Section Tittle  -->
                            <form id="contact-form" action="schAdd.php" method="POST">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
									<span><h2>Time</h2></span>
                                        <div class="form-box user-icon mb-30">
                                            <input type="time" placeholder="First name" id="t1" name="t1" required="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
									<span><h2>Date</h2></span>
                                        <div class="form-box subject-icon mb-30">
                                            <input type="date" placeholder="Last name" id="t2" name="t2" required="">
                                        </div>
                                    </div>
									<div class="col-lg-6 col-md-6">
									<span><h2>Select Member</h2></span>
                                        <div class="form-box user-icon mb-30">
                                            <select name="t3" id="select2" >
                                                <option value="0">Select a member</option>
                                                <?php
												$result = mysqli_query($con, "select  * from member") or die(mysqli_error($con));
												while ($result1 = mysqli_fetch_array($result)) {?>
												<option value="<?php echo $result1['mid'] ?>"><?php echo $result1['fnam']?> <?php echo $result1['lnam']?></option>
												<?php } ?> 
                                            </select>
                                        </div>
                                    </div>
