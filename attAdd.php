    ...
    <main>
        ...
        <div class="contact-form-main mb-100">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="form-wrapper">
                            ...
                            <table id="table" style="border=1px">
											...
											<tbody>
											   <?php
            $result11 = mysqli_query($con,"select * from member") or die(mysqli_error($con)); 
            while($result22 = mysqli_fetch_array($result11)){
            ...
            ?>
              ...
              <tr>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td><?php echo $result22['mid']; ?> </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['fnam']; ?> <?php echo $result22['lnam']; ?> </td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['address']; ?><br><?php echo $result22['pin']; ?> </td>
               <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['phone']; ?> </td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['email']; ?></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><?php echo $result22['age']; ?> </td>
